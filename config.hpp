...
#define ITER_CHEF 8000   // 选择厨师时的迭代次数
#define ITER_RECIPE 3000 // 对于每一组厨师，选择菜谱时的迭代次数
...
#define T_MAX_CHEF TARGET_SCORE_APPROXIMATE / 20000 // 选择厨师时的初始温度
#define T_MAX_RECIPE                                                           \
    TARGET_SCORE_APPROXIMATE / 20000 // 对于每一组厨师，选择菜谱时的初始温度
